          ...
          <div className="baglio-container relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mt-12">
              {services.map((service, index) => (
                <div key={index} className="group relative">
                  {/* Card */}
                  <div className="relative bg-baglio-ebano rounded-2xl overflow-hidden shadow-lg border border-baglio-oro/20 hover:border-baglio-oro/60 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-baglio-oro/25 backdrop-blur-sm p-6">
