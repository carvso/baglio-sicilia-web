    ...
    <Layout hideNavbar={false} hideFooter={false}>
      ...
      <section className="py-16 bg-white">
        <div className="baglio-container">
          <h2 className="text-3xl md:text-4xl font-playfair text-center mb-12">I Nostri Punti di Forza</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="mb-4 text-baglio-burgundy">
        ...
        <div className="baglio-container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow duration-300">
              ...
              />
              <div className="p-6">
                <div className="text-sm text-baglio-burgundy font-semibold mb-2">28 Maggio 2025</div>
                ...
                <Link to="/eventi" className="text-baglio-burgundy font-semibold hover:underline">
                  Scopri di più →
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow duration-300">
              ...
              />
              <div className="p-6">
                <div className="text-sm text-baglio-burgundy font-semibold mb-2">10 Giugno 2025</div>
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow duration-300">
              ...
              />
              <div className="p-6">
                <div className="text-sm text-baglio-burgundy font-semibold mb-2">15 Giugno 2025</div>
        ...
        <div className="baglio-container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-10">
            ...
            <div className="flex flex-col justify-center">
              <h3 className="text-2xl font-playfair font-semibold mb-4">Spazi versatili per ogni occasione</h3>
